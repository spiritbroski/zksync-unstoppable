    ...
    <div class="linkHeader">
      ...
      >
        ...
        <li class="mb-3">
          <i class="fad fa-check text-violet mr-2" />
          <span
            ><a href="https://zksync.io/api/sdk/checkout/" CLASS="lightLink" target="_blank">zkSync Checkout SDK</a
            >&nbsp;for the fully-featured checkout</span
          >
        </li>
        <li class="mb-3">
          <i class="fad fa-check text-violet mr-2" />
          ...
          <zk-note class="notificationNote">
            ...
            <template slot="default">
              <div class="text-sm text-gray font-light">
                To unlock <span class="font-normal">“Build your payment link”</span> button below make sure to fill-up
                <span class="font-normal">“Receiver ETH address”</span> and <span class="font-normal">“Amount”</span>
                {{ payments.length > 1 ? `for each of ${payments.length} transactions` : `of the transaction` }}.
              </div>
            </template>
          </zk-note>
        </div>
  ...
  computed: {
    ...
    createLinkBlockTitle(): string {
      ...
      return this.showAddLink
        ? `Compose batch of your ${ethNetwork} payments:`
